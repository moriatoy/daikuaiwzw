...
public class ProjectConfig {
    ...
    public static final String DEBUG_BASE_URL = "http://fuzhuangfaqianla.com:8080/";
    public static final String RELEASE_BASE_URL = "http://fuzhuangfaqianla.com:8080/";

    public static final int REQUES_OPEN_CAMERA = 10000;
    public static final int REQUES_OPEN_GALLERY = 10001;
