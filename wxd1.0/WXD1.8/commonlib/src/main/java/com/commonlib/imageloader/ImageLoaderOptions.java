...
public class ImageLoaderOptions {
    ...
    private int holderDrawable; //占位图片
    private ImageSize imageSize;    //设置图片的大小
    private int errorDrawable;  //加载错误的图片
    ...
    private boolean circleTransform = false;
    ...
    private ImageLoaderOptions (Builder builder){
        ...
        this.circleTransform = builder.circleTransfrom;
    ...
    public boolean isCircleTransform() {
    ...
    public final static class Builder{
        ...
        private DiskCacheStrategy mDiskCacheStrategy = DiskCacheStrategy.DEFAULT; //磁盘缓存策略
        private BaseTarget target = null; //target
        private boolean circleTransfrom = false;
        private boolean isCenterCrop = false;
        ...
        public Builder isCircleTransform(boolean circleTransfrom){
            this.circleTransfrom = circleTransfrom;
            return this;
        }
