 ...
 */
public class OnlineLoanViewBinder extends ItemViewBinder<OnlineLoan, OnlineLoanViewBinder.ViewHolder> {

    @NonNull
    @Override
    protected ViewHolder onCreateViewHolder(
            @NonNull LayoutInflater inflater, @NonNull ViewGroup parent) {
        View root = inflater.inflate(R.layout.index_fragment_item_online_loan, parent, false);
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()){
                case R.id.index_fragment_item_online_loan_ll:
                    ProductClickHelper.clickOnlineProduct(v.getContext(), ZhugeHelper.hot_loan_from, data);
                    break;
            }
        }
    }
