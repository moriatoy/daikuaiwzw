  ...
  <div class="productDetail">
    ...
    <div v-show="infoType==2">
      ...
      <!--<div class="apply-process">-->
        <!--&lt;!&ndash;<p class="left-border apply">&nbsp;&nbsp;申请流程</p>&ndash;&gt;-->
        <!--<div class="detail">-->
          <!--<div class="dashed-border"></div>-->
          <!--<div class="detail-cell clear" v-if="firstVisible">-->
          <!--&lt;!&ndash;<div class="detail-cell clear">&ndash;&gt;-->
            <!--&lt;!&ndash;<div class="left-cell fl">&ndash;&gt;-->
              <!--&lt;!&ndash;<img src="../../static/assets/1@2x.png">&ndash;&gt;-->
            <!--&lt;!&ndash;</div>&ndash;&gt;-->
            <!--<div class="middle-cell fl"><div></div></div>-->
            <!--<div class="right-cell fl">-->
              <!--<p>18周岁以上<span style="color:#f8c86c;">{{rateOne}}%</span>&nbsp;成功率</p>-->
            <!--</div>-->
          <!--</div>-->
          <!--&lt;!&ndash;<div class="detail-cell clear">&ndash;&gt;-->
          <!--<div class="detail-cell clear" v-if="secondVisible">-->
            <!--&lt;!&ndash;<div class="left-cell fl">&ndash;&gt;-->
              <!--&lt;!&ndash;<img src="../../static/assets/2@2x.png">&ndash;&gt;-->
            <!--&lt;!&ndash;</div>&ndash;&gt;-->
            <!--<div class="middle-cell fl"><div></div></div>-->
            <!--<div class="right-cell fl">-->
              <!--<p>身份认证<span style="color:#75f0e5;">{{rateTwo}}%</span>&nbsp;成功率</p>-->
            <!--</div>-->
          <!--</div>-->
          <!--&lt;!&ndash;<div class="detail-cell clear">&ndash;&gt;-->
          <!--<div class="detail-cell clear" v-if="thirdVisible">-->
            <!--&lt;!&ndash;<div class="left-cell fl">&ndash;&gt;-->
              <!--&lt;!&ndash;<img src="../../static/assets/3@2x.png">&ndash;&gt;-->
            <!--&lt;!&ndash;</div>&ndash;&gt;-->
            <!--<div class="middle-cell fl"><div></div></div>-->
            <!--<div class="right-cell fl">-->
              <!--<p>手机认证<span style="color:#fecfee;">{{rateThree}}%</span>&nbsp;成功率</p>-->
            <!--</div>-->
          <!--</div>-->
          <!--&lt;!&ndash;<div class="detail-cell clear">&ndash;&gt;-->
          <!--<div class="detail-cell clear" v-if="forthVisible">-->
            <!--&lt;!&ndash;<div class="left-cell fl">&ndash;&gt;-->
              <!--&lt;!&ndash;<img src="../../static/assets/4@2x.png">&ndash;&gt;-->
            <!--&lt;!&ndash;</div>&ndash;&gt;-->
            <!--<div class="middle-cell fl"><div></div></div>-->
            <!--<div class="right-cell fl">-->
              <!--<p>联系人认证<span style="color:#f8c86c;">{{rateFour}}%</span>&nbsp;成功率</p>-->
            <!--</div>-->
          <!--</div>-->
          <!--&lt;!&ndash;<div class="detail-cell clear">&ndash;&gt;-->
          <!--<div class="detail-cell clear" v-if="fifthVisible">-->
            <!--&lt;!&ndash;<div class="left-cell fl">&ndash;&gt;-->
              <!--&lt;!&ndash;<img src="../../static/assets/5@2x.png">&ndash;&gt;-->
            <!--&lt;!&ndash;</div>&ndash;&gt;-->
            <!--<div class="middle-cell fl"><div></div></div>-->
            <!--<div class="right-cell fl">-->
              <!--<p>社交账号QQ<span style="color:#fecfee;">{{rateFive}}%</span>&nbsp;成功率</p>-->
              <!--&lt;!&ndash;<p>&ndash;&gt;-->
                <!--&lt;!&ndash;<span style="color:#fecfee;">{{rateFive}}%</span>&ndash;&gt;-->
                <!--&lt;!&ndash;&nbsp;成功率&ndash;&gt;-->
              <!--&lt;!&ndash;</p>&ndash;&gt;-->
            <!--</div>-->
          <!--</div>-->
          <!--&lt;!&ndash;<div class="detail-cell clear">&ndash;&gt;-->
          <!--<div class="detail-cell clear" v-if="sixthVisible">-->
            <!--&lt;!&ndash;<div class="left-cell fl">&ndash;&gt;-->
              <!--&lt;!&ndash;<img src="../../static/assets/6@2x.png">&ndash;&gt;-->
            <!--&lt;!&ndash;</div>&ndash;&gt;-->
            <!--<div class="middle-cell fl"><div></div></div>-->
            <!--<div class="right-cell fl">-->
              <!--<p>芝麻信用分500以上 <span style="color:#75f0e5;">{{rateSix}}%</span>&nbsp;成功率</p>-->
            <!--</div>-->
          <!--</div>-->
        <!--</div>-->
      <!--</div>-->
...
import { getLoanProductById,channel } from '../Ajax/post.js';
export default {
  name: 'productDetail',
  components: {
    Tab,
